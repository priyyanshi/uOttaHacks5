// This library is from https://github.com/cfinke/Typo.js/blob/master/typo/typo.js */
  ...
  chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if (request.greeting === "hello"){
            ...
            const uniqueTypos = [];
            typos.forEach((string) => {
                const lowerCaseString = string.toLowerCase();

                if (!uniqueTypos.includes(lowerCaseString)) {
                    uniqueTypos.push(lowerCaseString);
                }
            });
            
            
            sendResponse({metadata: meta.length, images: no_alts, typos: uniqueTypos});
        }
    }   
);
